...
const EditProfile = ({
  ...
  // Check if user already has profile , if does update the formData
  useEffect(() => {
    getProfile();
    ...
    setFromData({
      ...
      skills:
        loading || !profileData.skills ? "" : profileData.skills.join(", "),
      instagram:
        loading || !profileData.socials ? "" : profileData.socials.instagram,
      facebook:
        loading || !profileData.socials ? "" : profileData.socials.facebook,
      linkedin:
        loading || !profileData.socials ? "" : profileData.socials.linkedin,
    });
  }, [loading]);
